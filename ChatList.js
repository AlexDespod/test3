...
class ChatList extends Component{
    constructor(props){
        ...
        this.state={
            ...
            newMessage:'',
            uncheck:[]
            // socket:new WebSocket('ws://192.168.0.101:8000/fetchserver/socket.php')
        }
    }
    i=0;
    ...
    // componentDidUpdate(){
    //     this.checkMessages(this.props.message);
    // }
    ...
    render(){
        ...
        <View style={styles.containerUser}>
            ...
            {/* <Text>{JSON.stringify(this.state.uncheck)}</Text> */}
             <FlatList
    ...
    checkMessages = (mass,name) =>{
        ...
        if(uncheckMass[name].count > 0){return <Text>You have {uncheckMass[name].count} messages</Text>}
